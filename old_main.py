...
from tools import pom_tools, java_tools, docker_tools
import shutil
import os, fnmatch
...
if __name__ == '__main__':
    ...
    docker = docker_tools.DockerTools('/Users/septemberhx/test/after/MFramework/Dockerfile')
    docker.add_labels({'modifiedByMF': 'true'})
    docker.modify_entrypoint('["java", "-jar", "test.jar"]')
